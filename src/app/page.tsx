        ...
        <div className="flex items-center justify-between">
          ...
          >
            <div className={`font-bold text-2xl md:text-3xl ${isScrolled ? 'text-gray-900' : 'text-white'}`}>
              <span className="text-amber-500">LN</span> Steel Furniture
            </div>
          </motion.a>
          ...
          <AnimatedSection variant="fadeInLeft">
            <div className="relative">
              ...
              >
                <img
                  src={productImages[2]}
                  alt="LN Steel Furniture Factory"
          ...
          <AnimatedSection variant="fadeInRight">
            <div>
              ...
              <p className="text-gray-600 text-lg mb-6">
                LN Steel Furniture has been a trusted name in premium steel furniture manufacturing for over a decade. We specialize in creating durable, elegant, and functional steel almirahs, wardrobes, and custom furniture solutions for homes, offices, and institutions.
              </p>
      ...
      <div className="container mx-auto px-4 relative">
        <AnimatedSection className="text-center mb-16">
          ...
          <h2 className="text-3xl md:text-5xl font-bold text-white mb-6">
            Why Customers Trust <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-400 to-orange-400">LN Steel Furniture</span>
          </h2>
...
function TestimonialsSection() {
  const testimonials = [
    ...
    },
    {
      ...
      location: 'Bhopal',
      message: 'I have been recommending LN Steel Furniture to all my clients. Their custom manufacturing service is exceptional.',
      rating: 5
    },
    {
      name: 'Amit Patel',
        ...
        <div className="border-t border-gray-800 pt-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-gray-500 text-sm">
              © 2024 LN Steel Furniture. All rights reserved.
            </p>
